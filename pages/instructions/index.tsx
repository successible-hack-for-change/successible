...
const Instructions: NextPage = () => {
  return (
    <PageLayout>
      ...
      <p>
        When your first question loads, your timer will begin. You can see your
        remaining time in the top right corner of the page. On the page you will
        see the question on the left, and the multiple choice answers on the
        right. To answer you will be able to click on one of the answers and
        then press the submit button. All questions and answers have the option
        to be read aloud if you click on the sound icon.
      </p>
      <p>
        ...
        the question, but it might include a diagram, definitions of some words
        in the question, or a highlights section that pulls out important
        information from the question.
      </p>
      <p>
        After you have submitted your question your answer will be logged and
        you will be taken to a “break” page before your next question. This page
        is not timed and you may take as long as you like before beginning your
        next question.
      </p>
      <p>

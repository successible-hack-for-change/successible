// Not in use right now due to NextJS / joyride incompatibility issues
// Keeping code for later use in different package

import dynamic from 'next/dynamic';

// Trying to avoid server-side rendering because of hydration issues
